...
export default class Login extends React.Component {
	...
	render() {
		...
		return (
			<div className="mt-4">
				<a href="/api/user/auth/google" className='block w-3/4 sm:w-2/4 mt-6 mx-auto border-solid border-2 border-purple-200 leading-none rounded-md shadow-md'><p className='text-3xl h-10 text-center flex items-center justify-center'><FcGoogle  className="-ml-7 mr-2" /><p className="text-2xl font-mono">Google</p></p></a>
				<a href="/api/user/auth/facebook" className='block w-3/4 sm:w-2/4 mt-6 mx-auto border-solid border-2 border-purple-200 leading-none rounded-md shadow-md'><p className='text-3xl h-10 text-center flex items-center justify-center'><AiFillFacebook className="mr-2 text-blue-800" /><p className="text-2xl font-mono">Facebook</p></p></a>
				<a href="/api/user/auth/github" className='block w-3/4 sm:w-2/4 mt-6 mx-auto border-solid border-2 border-purple-200 leading-none rounded-md shadow-md'><p className='text-3xl h-10 text-center flex items-center justify-center'><AiFillGithub className="-ml-8 mr-2" /><p className="text-2xl font-mono">Github</p></p></a>
				<p className='w-3/4 sm:w-2/3 text-purple-600 text-center font-mono mt-4 block mx-auto sm:text-md text-sm'>Or Login With Email Address</p>
